// tutorial20c.js
// optimistic -- teh snap is there.  Let's make the data out of order temporarily
// to show that our optimistic view doesn't always match reality's endstate
// and we have to make other measures to try and better predict the future
// so that users aren't confused by the changes as they come in
// NOTE: this is evident when the list reorders after ~10 seconds
...
var CommentBox = React.createClass({
    ...
    handleCommentSubmit: function (comment){
        ...
        // up the line
        var newCommentState = [comment].concat(curCommentState); // this is where we have reordered junk
